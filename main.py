...
for destination in sheet_data:
    ...
    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination["lowestPrice"]:
        ...
        if cheapest_flight.stops == 0:
            ...
            f"on {cheapest_flight.out_date} intil {cheapest_flight.return_date}."
        ...
        notification_manager.send_emails(email_lsit=customer_email_list, email_body=message)